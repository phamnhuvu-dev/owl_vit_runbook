...
# # Avoid rate limit
# update_file('scenic_repo/scenic/projects/owl_vit/clip/tokenizer.py', 'DEFAULT_BPE_PATH = None', 'DEFAULT_BPE_PATH = \'/root/.cache/scenic/clip/bpe_simple_vocab_16e6.txt.gz\'')
